...
class HouseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = House
        fields = [
                  'title','owner_id', 'description', 'location', 'base_price', 'extra_costs', 'taxes',
    ...
    def save(self):
        house = House(
            title = self.validated_data['title'],owner_id = self.validated_data['owner_id'],
            ...
            washing_machine = self.validated_data['washing_machine'], air_conditioning = self.validated_data['air_conditioning'],
